...
# эллипса орбиты самой далекой планеты. Каждая орбита представляет из себя кортеж из пары 
# чисел - полуосей ее эллипса. Площадь эллипса вычисляется по формуле S = pi*a*b,
...
def find_farthest_orbit(orbits):
    return max([(a[0]*a[1], a) for a in orbits if a[0]!=a[1]])[1]
    
# формуриуем кортеж, состоящий из значения площади и кортежа
# [1] обращаемся к первому индексу
# под нулевым индексом - значение площади, под первым - кортеж с координатами
